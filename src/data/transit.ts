...
export const mockLines: Line[] = [
  ...
  // Sample real São Paulo bus lines (mocked data)
  {
    id: "b5010",
    name: "5010 - Av. Paulista",
    type: "bus",
    color: "#f59e0b",
    stations: [
  ...
  {
    id: "b8700",
    name: "8700 - Terminal Pinheiros",
    type: "bus",
    color: "#fb7185",
    stations: [
      { name: "Terminal Pinheiros" },
      { name: "R. dos Pinheiros" },
      { name: "Av. Faria Lima" },
      { name: "Av. Rebouças" },
      { name: "Terminal Santo Amaro" },
    ],
    status: "warning",
    statusMessage: "Desvio pela Rua Augusta",
  },
  {
    id: "b875",
    name: "875 - Circular Centro",
    type: "bus",
    color: "#06b6d4",
    stations: [
      { name: "Sé" },
    ...
    status: "ok",
    statusMessage: "Circular operando normalmente",
  },
];
...
export const mockTickets: TicketCard[] = [
  ...
  { id: "t2", type: "top", name: "Cartão TOP", number: "**** **** **** 8891", balance: 22.50, lastUsed: "Ontem, 18:15" },
];
